<template>
	<transition appear appear-class="slide-fade-enter" appear-active-class="slide-fade-enter-active">
		<div>
				...
				<div class="row">
					...
					<div class="col" style="margin-top: 10%">
						...
						<div style="text-align: left">
							<p>Avoid the hassle of 111112fsdfsd22the Excel credit tracking sheet <font-awesome-icon icon="check-circle" style="color: green" /> </p>
			...
			<div class="footer">
				Made with <font-awesome-icon icon="heart" style="color: lightpink" /> by team 17
			</div>
		</div>
	</transition>
</template>
